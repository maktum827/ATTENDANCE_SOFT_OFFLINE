...
function SETUPDATA() {
  ...
  const { data: academyData, isLoading: academyLoading } = useGetAcademyQuery();
      ...
      <Grid container spacing={2}>
        ...
        <Grid item container spacing={2} md={7} xs={12}>
          ...
          <Grid item md={12}>
            ...
            >
              <CardHeader sx={{ pt: 1, pb: 1 }} title={t('manageClasses')} />
              <Divider />
              <CardContent>
                {/* Plain HTML form */}
                <form
          ...
          <Grid item md={12}>
            <Card sx={{ borderRadius: 3, boxShadow: 0 }}>
              <CardHeader sx={{ pt: 1, pb: 1 }} title={t('manageGroupes')} />
              <Divider />
              <CardContent>
                {/* Plain HTML form */}
                <form
